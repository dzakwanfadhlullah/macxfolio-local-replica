...
export default function Preloader({ onDone }: PreloaderProps) {
  ...
  useEffect(() => {
    ...
    animate(".hello-mark", { opacity: 0 }, { duration: 0.24 })
  }, [leaving, reduceMotion])

  return (
    <div ref={curtain} className="preloader" aria-label="Loading portfolio">
      <svg className="hello-mark" viewBox="0 0 638 200" fill="none" stroke="white" strokeWidth="14.8883" aria-hidden="true">
        <motion.path
          d={shortPath}
          strokeLinecap="round"
